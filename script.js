...
//This is a more compact version of the compareGuesses function, but it omits the alert. I also prefer the step-by-step
//readability of the first implementation.
//const compareGuesses = (humanGuess, computerGuess, targetNumber) => getAbsoluteDistance(humanGuess, targetNumber) <= getAbsoluteDistance(computerGuess,targetNumber);
